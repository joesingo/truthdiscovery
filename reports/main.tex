...
% TODO:
%
% * Mention somewhere that software implementation can be used for canonical
...
% Roman numerals for title, abstract and table of contents
\pagenumbering{roman}
...
% Usual numbering for body of report
