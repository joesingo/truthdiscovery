...

{
    ...
    \captionof{figure}{Network in which Sums does not rank all sources equally}
    \label{img:sums_not_all_equal_trust}
}

\begin{proof}
Assume Sums is convergent. Since trust and belief scores for Sums are always in
the range $[0, 1]$ lemma \ref{lemma:iterative_axiom_suff_conds} can be applied.
...

{
    ...
    \captionof{figure}{
        Network containing the network in figure
        \ref{img:sums_not_all_equal_trust} as a connected component, but in
        which Sums does not give the same ranking of the sources in this
        component.
    }
