...
Figure \ref{img:sums_non_indep} and figure \ref{img:sums_not_all_equal_trust}
provides an example of Sums failing to satisfy independence. The details can be
